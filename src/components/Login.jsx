...
const Login = () => {
    //Initialize Firebase authetification and navigation
    const auth = getAuth();
    const navigate = useNavigate();

    //State variables for managing authentification state, email, pwd, and errors messages
    ...
    //function to handle sign-in with  email and pwd
    const signInWithEmail = async () => {
        setAuthing(true);
        setError('');

        //Use Firebase to sign-in with email and pwd
       ...
       <div className='w-1/2 h-full flex flex-col bg-[#282c34] items-center justify-center'></div>
        ...
        <div className='w-1/2 h-full bg-[#1a1a1a] flex flex-col p-20 justify-center'>
           <div className='w-full flex flex-col max-w-[450px] mx-auto'>
            ...
            <div className='w-full flex flex-col md-10 text-white'>
               <h3 className='text-4xl font-bold mb-2'>Login</h3>
               <p className='text-lg mb-4'>Welcome back! Please enter your details</p>
            </div>

            {/*Input fields for email and pwd */}
            ...
            {/* Button to log in with email and password */}
                    ...
                    <button
                        className='w-full bg-cyan-400 text-black font-semibold rounded-md p-4 text-center flex items-center justify-center cursor-pointer mt-7'
